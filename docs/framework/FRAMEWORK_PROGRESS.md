...
## Snapshot (2026-06-29)
- Framework HEAD / origin/main: `59db59c015451fce94bd0c456399d6928338e1c7` (F0-E ledger closed; F1-A audit complete).
...
| F1-B | Minimal E402 fix | IN PROGRESS | Move auto-loop import to top; import `_GIT_LOCAL_ENV_VARS` from `_git_utils`; update progress doc. |
| F1-C | Test performance plan/fix | PLANNED | Cache/scope real git repo setup; target <120s narrative suite. |
...
| F1-A | yes | — | — | — | — |
| F1-B | yes | yes (pre-commit) | — | pending | pending |
