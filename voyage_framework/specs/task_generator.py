...
from voyage_framework.core.models import Event, EventType, TaskSpec
...
class TaskGenerator:
    ...
    def generate(
        ...
        context_json = {
            ...
            "project_id": project_id,
            "context_summary": (
                f"Project {project_id}: {project_context.get('total_events', 0)} events"
            ),
            "relevant_files": all_files,
            "rules": rules,
            "adrs": all_adrs,
        ...
        spec = TaskSpec(
            ...
            micro_phase=micro_phase,
            project_id=project_id,
            context_summary=str(context_json["context_summary"]),
            relevant_files=all_files,
            rules=rules,
            adrs=all_adrs,
            criteria=all_criteria,
    ...
    def _generate_task_md(
        ...
        if relevant_files:
            ...
            files_section = "- Определи самостоятельно"
...
---
Generated by Voyage Framework v4.0 | Task ID: will-be-set | Date: {
